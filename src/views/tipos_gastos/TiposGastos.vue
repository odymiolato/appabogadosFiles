            ...
            <form>
                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input id="tipgas_tga" type="text" maxlength="1" class="w-full mt-2 border-gray-200 rounded-md focus:border-indigo-600 focus:ring focus:ring-opacity-40 focus:ring-indigo-500">
                    </div>

                    <div>
                        <label class="text-gray-700" for="descri_tga">Descripción</label>
                        <input id="descri_tga" type="text" maxlength="50" class="w-full mt-2 border-gray-200 rounded-md focus:border-indigo-600 focus:ring focus:ring-opacity-40 focus:ring-indigo-500">
                    </div>
