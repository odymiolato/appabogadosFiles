        ...
        <div class="w-full px-6 mt-6">
          <div class="flex flex-col px-5 py-6 gap-3 bg-white rounded-md shadow-sm h-[180px]">
            <div>
              ...
              <Label labeltext="1500" labelclass="" />
            </div>
            <div>
              <Label labeltext="Fecha:   " labelclass="font-bold" />
              <Label labeltext="10/10/2024" labelclass="" />
            </div>
            <div>
              <Label labeltext="Cliente:   " labelclass="font-bold" />
      ...
      <div class="md:flex">
        <ul
          ...
          <li>
            <div @click="ChageTaps(1)"
              :class="`inline-flex items-center px-4 py-3 rounded-lg active w-full select-none cursor-pointer ${(tap === 1) ? 'text-white bg-sky-700 ' : 'hover:text-gray-900 bg-white hover:bg-gray-100 w-full text-gray-700'}`">
              <svg :class="`w-4 h-4 me-2 ${(tap === 1) ? 'text-white' : 'text-gray-700'}`" aria-hidden="true"
          ...
          <li>
            <div @click="ChageTaps(2)"
              :class="`inline-flex items-center px-4 py-3 rounded-lg active w-full select-none cursor-pointer ${(tap === 2) ? 'text-white bg-sky-700 ' : 'hover:text-gray-900 bg-white hover:bg-gray-100 w-full text-gray-700'}`">
              <svg :class="`w-4 h-4 me-2 ${(tap === 2) ? 'text-white' : 'text-gray-700'}`" aria-hidden="true"
          ...
          <li>
            <div div @click="ChageTaps(3)"
              :class="`inline-flex items-center px-4 py-3 rounded-lg active w-full select-none cursor-pointer ${(tap === 3) ? 'text-white bg-sky-700 ' : 'hover:text-gray-900 bg-white hover:bg-gray-100 w-full text-gray-700'}`">
              <svg :class="`w-4 h-4 me-2 ${(tap === 3) ? 'text-white' : 'text-gray-700'}`" aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                <path
          ...
          <li>
            <div div @click="ChageTaps(4)"
              :class="`inline-flex items-center px-4 py-3 rounded-lg active w-full select-none cursor-pointer ${(tap === 4) ? 'text-white bg-sky-700 ' : 'hover:text-gray-900 bg-white hover:bg-gray-100 w-full text-gray-700'}`">
              <svg :class="`w-4 h-4 me-2 ${(tap === 4) ? 'text-white' : 'text-gray-700'}`" aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                <path
        ...
        <div id="tap-2"
          ...
          <div class="my-6 flex w-full flex-col">
            ...
            <div class="border border-solid flex flex-row">
              <div class="flex-[60%] flex flex-col gap-4 py-5">
                <div>
                  <Label labeltext="Ingresos" labelclass="font-bold text-black ml-5" />
                </div>
                <div>
                  <Label labeltext="Gastos" labelclass="font-bold text-black ml-5" />
                </div>
              </div>
              <div class="flex-[40%]">
                test 2
