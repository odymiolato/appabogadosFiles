...
import type { abogados, clientes, contrapartes, tipos_expedientes, tribunales } from '../../class/all.class'
import { ExpedienteDetalle, expedientes } from '../../class/all.class'
...
const searchTermTipoExpediente = ref('')
const searchTermAbogado = ref('')
const searchTermCliente = ref('')
const searchTermContraparte = ref('')
const searchTermTribunal = ref('')
...
function setTipoExpediente(obj: tipos_expedientes) {
  if (TipoExpedienteSelected.value !== undefined) {
...
function setAbogado(obj: abogados) {
  if (AbogadoSelected.value !== undefined) {
...
function setCliente(obj: clientes) {
  if (ClienteSelected.value !== undefined) {
...
function setContraparte(obj: contrapartes) {
  if (ContraparteSelected.value !== undefined) {
...
function setTribunal(obj: tribunales) {
  if (TribunalSelected.value !== undefined) {
...
async function saveExpediente() {
  try {
    ...
    ExpedienteHeader.value.tipexp_exp = Number.parseInt(TipoExpedienteSelected.value.tipexp_tip)
...
<template>
        ...
        <div class="flex flex-col gap-6 mt-4 sm:grid-cols-2">
          <div>
            <div class="">
              ...
              <input
                id="motivo_exp" v-model="ExpedienteHeader.descri_exp"
                type="text"
          ...
          <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            ...
            <div class="">
              ...
              <div class="flex gap-2 justify-center items-center">
                <input
                  id="fecnac_abo" v-model="TipoExpedienteSelected.tipexp_tip" type="text"
                  disabled
                ...
                <input
                  id="fecnac_abo" v-model="TipoExpedienteSelected.descri_tip"
                  type="text"
      ...
      <div class="md:flex">
        ...
        >
          ...
          <div class="">
            ...
            <div class="flex gap-2 justify-center items-center">
              <input
                id="fecnac_abo" v-model="AbogadoSelected.codabo_abo" type="text"
                disabled
                class="w-[20%] mt-2 border-gray-200  rounded-md focus:border-sky-600 focus:ring focus:ring-opacity-40 focus:ring-sky-500" readonly
              >

              <input
                id="fecnac_abo" v-model="AbogadoSelected.nombre_abo"
                type="text"
                class="w-full mt-2 border-gray-200 rounded-md focus:border-sky-600 focus:ring focus:ring-opacity-40 focus:ring-sky-500" readonly
              >

              <button
                type="button" class="mt-1 p-3  text-sm font-medium text-white bg-sky-700 rounded-lg border border-sky-700 hover:bg-sky-800 focus:ring-4 focus:outline-none focus:ring-sky-300"
        ...
        >
          ...
          <div class="">
            ...
            <div class="flex gap-2 justify-center items-center">
              <input
                id="fecnac_abo" v-model="ClienteSelected.codcli_cli" type="text"
                disabled
                class="w-[20%] mt-2 border-gray-200  rounded-md focus:border-sky-600 focus:ring focus:ring-opacity-40 focus:ring-sky-500" readonly
              >

              <input
                id="fecnac_abo" v-model="ClienteSelected.nombre_cli"
                type="text"
                class="w-full mt-2 border-gray-200 rounded-md focus:border-sky-600 focus:ring focus:ring-opacity-40 focus:ring-sky-500" readonly
              >
              ...
              <button
                class="flex mt-1 p-3  text-sm font-medium text-white bg-green-500 rounded-lg border hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300"
                @click="addCliente(parseInt(ClienteSelected.codcli_cli), ClienteSelected.nombre_cli)"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor" stroke-width="2"
              ...
              <button
                class="flex mt-1 p-3  text-sm font-medium text-white bg-red-500 rounded-lg border hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300"
                @click="removeCliente(ClienteSelected.codcli_cli)"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor" stroke-width="2"
            ...
            <div class="">
              <div class="rounded-md shadow bg-white h-[17.9em] max-h-[17.9em] overflow-auto">
                <table class="w-full text-left border-collapse">
                  ...
                  <tbody>
                    <tr
                      v-for="(value, index) in ClientesList" :key="index" class="hover:bg-gray-200"
        ...
        >
          ...
          <div class="">
            ...
            <div class="flex gap-2 justify-center items-center">
              <input
                id="fecnac_abo" v-model="ContraparteSelected.codcon_con" type="text"
                disabled
                class="w-[20%] mt-2 border-gray-200  rounded-md focus:border-sky-600 focus:ring focus:ring-opacity-40 focus:ring-sky-500" readonly
              >

              <input
                id="fecnac_abo" v-model="ContraparteSelected.nombre_con"
                type="text"
                class="w-full mt-2 border-gray-200 rounded-md focus:border-sky-600 focus:ring focus:ring-opacity-40 focus:ring-sky-500" readonly
              >
              ...
              <button
                class="flex mt-1 p-3  text-sm font-medium text-white bg-green-500 rounded-lg border hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300"
                @click="addContraparte(parseInt(ContraparteSelected.codcon_con), ContraparteSelected.nombre_con)"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor" stroke-width="2"
              ...
              <button
                class="flex mt-1 p-3  text-sm font-medium text-white bg-red-500 rounded-lg border hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300"
                @click="removeContraparte(ContraparteSelected.codcon_con)"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor" stroke-width="2"
            ...
            <div class="">
              <div class="rounded-md shadow bg-white h-[17.9em] max-h-[17.9em] overflow-auto">
                <table class="w-full text-left border-collapse">
                  ...
                  <tbody>
                    <tr
                      v-for="(value, index) in ContrapartesList" :key="index" class="hover:bg-gray-200"
        ...
        >
          ...
          <div class="">
            ...
            <div class="flex gap-2 justify-center items-center">
              <input
                id="fecnac_abo" v-model="TribunalSelected.codtri_tri" type="text"
                disabled
                class="w-[20%] mt-2 border-gray-200  rounded-md focus:border-sky-600 focus:ring focus:ring-opacity-40 focus:ring-sky-500" readonly
              >

              <input
                id="fecnac_abo" v-model="TribunalSelected.descri_tri"
                type="text"
                class="w-full mt-2 border-gray-200 rounded-md focus:border-sky-600 focus:ring focus:ring-opacity-40 focus:ring-sky-500" readonly
              >
              ...
              <button
                class="flex mt-1 p-3  text-sm font-medium text-white bg-green-500 rounded-lg border hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300"
                @click="addTribunal(parseInt(TribunalSelected.codtri_tri), TribunalSelected.descri_tri)"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor" stroke-width="2"
              ...
              <button
                class="flex mt-1 p-3  text-sm font-medium text-white bg-red-500 rounded-lg border hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300"
                @click="removeTribunal(TribunalSelected.codtri_tri)"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor" stroke-width="2"
            ...
            <div class="">
              <div class="rounded-md shadow bg-white h-[17.9em] max-h-[17.9em] overflow-auto">
                <table class="w-full text-left border-collapse">
                  ...
                  <tbody>
                    <tr
                      v-for="(value, index) in TribunalesList" :key="index" class="hover:bg-gray-200"
  ...
  <Modal
    v-if="showModal" class="flex justify-center items-center" :title="TypeModalTittle[TypeModal - 1]"
    :btn-visible="false" @close="handleClose" @accept="handleAccept" @decline="handleDecline"
  >
    <template #body>
      <div v-if="TypeModal === 1">
        <Inputs
          typeinput="search" labeltext="Buscar" :Value="searchTermTipoExpediente"
            ...
            <div class="mt-2">
              <div class="my-6 overflow-hidden bg-white rounded-md shadow max-h-[289px] overflow-y-auto">
                <table class="w-full text-left border-collapse">
                  ...
                  <tbody>
                    <tr
                      v-for="(value) in filteredTipoExpediente" class="hover:bg-gray-200 cursor-pointer"
            ...
            <div class="mt-2">
              <div class="my-6 overflow-hidden bg-white rounded-md shadow max-h-[289px] overflow-y-auto">
                <table class="w-full text-left border-collapse">
                  ...
                  <tbody>
                    <tr
                      v-for="(value) in filteredAbogado" class="hover:bg-gray-200 cursor-pointer"
            ...
            <div class="mt-2">
              <div class="my-6 overflow-hidden bg-white rounded-md shadow max-h-[289px] overflow-y-auto">
                <table class="w-full text-left border-collapse">
                  ...
                  <tbody>
                    <tr
                      v-for="(value) in filteredCliente" class="hover:bg-gray-200 cursor-pointer"
            ...
            <div class="mt-2">
              <div class="my-6 overflow-hidden bg-white rounded-md shadow max-h-[289px] overflow-y-auto">
                <table class="w-full text-left border-collapse">
                  ...
                  <tbody>
                    <tr
                      v-for="(value) in filteredContraparte" class="hover:bg-gray-200 cursor-pointer"
            ...
            <div class="mt-2">
              <div class="my-6 overflow-hidden bg-white rounded-md shadow max-h-[289px] overflow-y-auto">
                <table class="w-full text-left border-collapse">
                  ...
                  <tbody>
                    <tr
                      v-for="(value) in filteredTribunal" class="hover:bg-gray-200 cursor-pointer"
